...
INSERT INTO songs (title, artist, moood, duration, released)
...
SELECT tile FROM songs;

/*Show the title of the songs that have an 'epic' mood or a release date after 1990.*/
